...
import { useLearnerAssignments } from '@/features/assignments/hooks/useLearnerAssignments';
...
export default function AssignmentsPage({ params }: AssignmentsPageProps) {
  ...
  const { data: assignmentsData, isLoading: assignmentsLoading, error } = useLearnerAssignments();
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              {isOverdue 
                                ? `${Math.abs(assignment.daysLeft)}일 지남` 
                                : `${assignment.daysLeft}일 남음`
                              }
                            </span>
                          </div>
                          {assignment.submissionStatus === 'graded' && assignment.score !== null && (
                            <div className="flex items-center gap-1">
                              ...
                              <span>점수: {assignment.score}점</span>
                            </div>
                          )}
                        </div>
                      </div>
